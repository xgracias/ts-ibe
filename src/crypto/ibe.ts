...
export async function encryptOnG1(
  master: PointG1,
  ID: Uint8Array,
  msg: Uint8Array
): Promise<Ciphertext> {
  if (msg.length >> 8 > 1) {
    throw new Error(
      "cannot encrypt messages larger than our hash output: 256 bits."
    );
  }
...
export async function encryptOnG2(
  master: PointG2,
  ID: Uint8Array,
  msg: Uint8Array
): Promise<CiphertextOnG2> {
  if (msg.length >> 8 > 1) {
    throw new Error(
      "cannot encrypt messages larger than our hash output: 256 bits."
    );
...
export async function decryptOnG1(
  p: PointG2,
  c: Ciphertext
): Promise<Uint8Array> {
...
export async function decryptOnG2(
  p: PointG1,
  c: CiphertextOnG2
): Promise<Uint8Array> {
